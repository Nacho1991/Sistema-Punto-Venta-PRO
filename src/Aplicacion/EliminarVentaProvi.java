 ...
 * @author Beto
 */
public class EliminarVentaProvi extends javax.swing.JFrame {
    ...
    public EliminarVentaProvi() throws ClassNotFoundException {
        initComponents();
        Inicializar();
        InicializarDetalle();
        ...
        try {
            ...
            try {
                ...
                while (datos.next()) {
                    ...
                    cajero = datos.getString(5);
                    nombre = datos.getString(6);
                    Object datostabla[] = {codigo, fecha, hora, tipoPago, cajero, nombre};
                    modeloVentas.addRow(datostabla);
                }
                tablaFactura.setModel(modeloVentas);
            } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        tablaFactura.setComponentPopupMenu(menuPrincipal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarVentaProvi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new EliminarVentaProvi().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(EliminarVentaProvi.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
