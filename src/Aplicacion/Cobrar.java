...
public class Cobrar extends javax.swing.JFrame {
    ...
    public Cobrar(float total, Ventas pVen, DefaultTableModel pRecibemodelo, String cajero, int pID) throws ClassNotFoundException {
        this.con = new Conexion();
        initComponents();
        setLocationRelativeTo(null);
        txtTotCont.setText(String.valueOf(total));
        txtTotCredito.setText(String.valueOf(total));
        ...
        ven = pVen;
        modeloRecibeVentas = pRecibemodelo;
        idGlobal = pID;
        GenerarDetalle();
        try {
    ...
    private Cobrar() throws ClassNotFoundException {
        this.con = new Conexion();
...
//                    estado = this.con.InsertarVenta(envia);
                    ...
                    String envias;
                    String estados;
                    envias = "values ('" + id + "','" + txtTotCont.getText() + "','" + txtPagaCOnt.getText() + "','" + txtSuVueltCont.getText() + "')";
...
//                    }
                    String envia;
                    String estado;
                    envia = " values ('" + idClienteGlobal + "','" + txtSaldo.getText() + "','" + getDate() +"','"+txtTotCredito.getText()+ "')";
...
//                    v.setVisible(true);
    ...
    private void initComponents() {
        ...
        txtTotCredito = new javax.swing.JLabel();
        ...
        btnCobrareImprimir1 = new javax.swing.JButton();
        ...
        txtTotCredito.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        txtTotCredito.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtTotCredito.setText("0");
        txtTotCredito.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtTotCreditoKeyPressed(evt);
            }
        });
        ...
        txtabono.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        btnCobrareImprimir1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnCobrareImprimir1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/printer.png"))); // NOI18N
        btnCobrareImprimir1.setText("F1-COBRAR E IMPRIMIR");
        btnCobrareImprimir1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCobrareImprimir1ActionPerformed(evt);
            }
        });
        btnCobrareImprimir1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnCobrareImprimir1KeyPressed(evt);
            }
        });

        btnCancelar1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnCancelar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/erase.png"))); // NOI18N
        btnCancelar1.setText("ESC-CANCELAR");
        ...
        txtClienteCredito.setEditable(false);
        txtClienteCredito.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txtClienteCredito.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtClienteCredito.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtClienteCreditoKeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtClienteCredito, javax.swing.GroupLayout.PREFERRED_SIZE, 440, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(29, 29, 29)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtTotCredito, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtabono, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnCobrareImprimir1, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel31)
                    .addComponent(txtClienteCredito, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton1))
                .addGap(25, 25, 25)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(jLabel14)
                    .addComponent(txtTotCredito)
                    .addComponent(btnCobrareImprimir1, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(jLabel15)
        ...
        tabledpane.addTab("Credito", jPanel3);
    ...
    private void txtTotCreditoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTotCreditoKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == evt.VK_F1) {
            btnCobrareImprimir1ActionPerformed(null);
        }
        if (evt.getKeyCode() == evt.VK_ESCAPE) {
            this.dispose();
        }
    }//GEN-LAST:event_txtTotCreditoKeyPressed

    private void txtabonoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtabonoKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == evt.VK_ENTER) {
            double to = Double.parseDouble(txtTotCredito.getText());
            double paga = Double.parseDouble(txtabono.getText());
            double total = to - paga;
    ...
    private void btnCobrareImprimir1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCobrareImprimir1ActionPerformed
        // TODO add your handling code here:
        cobrarCredito();
    }//GEN-LAST:event_btnCobrareImprimir1ActionPerformed

    private void btnCobrareImprimir1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCobrareImprimir1KeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == evt.VK_F1) {
            btnCobrareImprimir1ActionPerformed(null);
        }
    ...
    }//GEN-LAST:event_btnCobrareImprimir1KeyPressed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            // TODO add your handling code here:
            BuscarCliente bu = new BuscarCliente(this);
            bu.setVisible(true);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Cobrar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void txtClienteCreditoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtClienteCreditoKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == evt.VK_F1) {
            btnCobrareImprimir1ActionPerformed(null);
        }
    ...
    }//GEN-LAST:event_txtClienteCreditoKeyPressed
    ...
    private javax.swing.JButton btnCobrareImprimir1;
    ...
    private javax.swing.JLabel txtTotCredito;
