 ...
 * @author Edgar
 */
public class ReimprimirVentaContado {
    ...
    public ReimprimirVentaContado(String idVenta, String cliente, DefaultTableModel modelo, String cajero, String caja, String total, String pagacon, String vuelto, String pconcept, String phora, String pfecha) throws ClassNotFoundException {
        model = modelo;
        cajeroLocal = cajero;
        cajaLocal = caja;
        totalocal = total;
        ...
        try {
            ...
            Logger.getLogger(ReimprimirVentaContado.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
