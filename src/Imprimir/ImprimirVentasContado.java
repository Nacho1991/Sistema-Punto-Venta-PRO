 ...
 * @author Edgar
 */
public class ImprimirVentasContado {
    ...
    public ImprimirVentasContado(String idVenta, String cliente, DefaultTableModel modelo, String cajero, String caja, String total, String pagacon, String vuelto) throws ClassNotFoundException {
        model = modelo;
        cajeroLocal = cajero;
        cajaLocal = caja;
        totalocal = total;
    ...
    public void sinImprimir() throws SQLException {
        ...
        while (datos.next()) {
            ...
            DatosImprimir.add(localidad = datos.getString(6));
