 ...
 * @author JERSON
 */
public class ImprimirVentaTarjeta {
    ...
    public ImprimirVentaTarjeta(String idVenta, String cliente, DefaultTableModel modelo, String cajero, String caja, String total, String nTransaccion) throws ClassNotFoundException {
        model = modelo;
        cajeroLocal = cajero;
        cajaLocal = caja;
        totalocal = total;
...
//            Logger.getLogger(ImprimirVentaTarjeta.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        String cadena = "";
//        String nombre = "";
//        String localidad = "";
